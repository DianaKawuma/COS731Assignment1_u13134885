...
export class MeatFishPoultryComponent {
  ...
  meatFishPoultry = [
    { category: 'MeatFishPoultry', categoryType: 'Poultry' , itemName: "Chicken", photolink: "../assets/box_img4.jpg", price: 50 },
    { category: 'MeatFishPoultry', categoryType: 'Beef' , itemName: "Steak", photolink: "../assets/page3_img6.jpg", price: 60 },
